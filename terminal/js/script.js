...
var prephrase = '<span class="red">drafi@arch</span>:<span class="blue">~</span># ';
...
{
	var res = '';
	if (command === './welcome.sh') res = 'Welcome to <span class="red">Drafi\'\s Arch Terminal</span><br></span><br>Made By:</span><span class="red"> ZacK#3585 & Drafi#0001</span><br><br><b>Type \'help\' for more details on the commands</b>'
	else
	{
	...
	try {
		...
		if (root > 0) {
			...
			if (vInput.startsWith("./")) {
				...
				neofetch({
						cmd: $('input').val(),
						res: '<div>drafi@arch</span><br><span class="red">OS:</span> Arch Linux ' + OSVer + '<br><span class="red">Kernel:</span> ' + Kernel + '<br><span class="red">Uptime:</span> ' + upTime + '<br><span class="red">Shell:</span> ' + Shell + '<br><span class="red">Disk:</span> ' + Disk + '<br></p></div>'
					});
			} else if (vInput.trim() !== "") {
